...
import com.spark.coinpaypddd.adapter.ApiAddressAdapter;
...
public class ApiActivity extends BaseActivity {
    ...
    protected void loadData() {
        ...
        list.add(new ApiAddressEntity("币赚", "bizhuanex.com"));
        list.add(new ApiAddressEntity("币客", "bikeshangmao.com"));
        list.add(new ApiAddressEntity("币安", "bittoppayment.top"));
        list.add(new ApiAddressEntity("币付", "bittopbian.work"));
        list.add(new ApiAddressEntity("搬搬赚", "newbtc.online"));
        list.add(new ApiAddressEntity("欧沃", "caymanex.pro"));
        list.add(new ApiAddressEntity("合众承兑", "555hub.com"));
        list.add(new ApiAddressEntity("希锦支付", "bifushangmao.com"));
        list.add(new ApiAddressEntity("点币支付(亿易商贸)", "dbipay.com"));
        ...
        list.add(new ApiAddressEntity("蚂蚁搬砖", "1688up.net"));
        list.add(new ApiAddressEntity("网思", "51ws.vip"));
        list.add(new ApiAddressEntity("BTD", "btd.bifushangmao.com"));
        list.add(new ApiAddressEntity("Subverter", "sub.bifushangmao.com"));
        list.add(new ApiAddressEntity("泰达易宝", "hn772.cn"));
