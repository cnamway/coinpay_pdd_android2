...
public class BuyConfirmActivity extends BaseActivity implements BuyContract.ConfirmView {
    ...
    protected void initView(Bundle saveInstance) {
        ...
        if (bundle != null) {
            ...
            tvPayMoney.setText(MathUtils.subZeroAndDot(money) + " CNY");
            tvAmount.setText(MathUtils.subZeroAndDot(price) + " CNY/" + coinName);
            tvUse.setText(MathUtils.subZeroAndDot(amount) + " " + coinName);
