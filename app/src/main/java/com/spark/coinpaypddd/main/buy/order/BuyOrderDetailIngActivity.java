...
import com.spark.coinpaypddd.main.buy.BuyCancelPresenterImpl;
import com.spark.coinpaypddd.main.buy.BuyContract;
import com.spark.coinpaypddd.main.buy.BuyPayFinishActivity;
import com.spark.coinpaypddd.main.buy.PayEntity;
        ...
        if (bundle != null) {
            ...
            if (payEntity != null) {
                try {
                    ...
                    tvSeller.setText("" + payEntity.getMakerName());
