...
public interface BindAccountContract {
    ...
    interface BankPresenter extends BaseContract.BasePresenter {
        ...
        void doBindBank(String payType, String account, String bank, String branch, String tradePassword, String etWarn, String dayLimit, String qrCodeUrl, String name);

        void doUpdateBank(Long id, String payType, String accout, String bank, String branch, String tradePassword, String etWarn, String dayLimit, String qrCodeUrl, String name);
    ...
    interface PaypalPresenter extends BaseContract.BasePresenter {
        ...
        void doBindPaypal(String payType, String account, String bank, String branch, String tradePassword, String etWarn, String dayLimit, String name, String expandField);

        void doUpdatePaypal(Long id, String payType, String account, String bank, String branch, String tradePassword, String etWarn, String dayLimit, String name, String expandField);
    }
}
