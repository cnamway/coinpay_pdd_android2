...
public class BindBankPresenterImpl implements BindAccountContract.BankPresenter {
     ...
     */
    @Override
    public void doBindBank(String payType, String payAddress, final String bankNum, String branch, String tradePassword, String etWarn, String dayLimit, String qrCodeUrl,String name) {
        showLoading();
        payControllerModel.doBindBank(payType, payAddress, bankNum, branch, tradePassword, qrCodeUrl, etWarn, dayLimit, "", "",name,"",
     ...
     */
    @Override
    public void doUpdateBank(Long id, String payType, String payAddress, String bankNum, String branch, String tradePassword, String etWarn, String dayLimit, String qrCodeUrl,String name) {
        showLoading();
        payControllerModel.doUpdateBank(id, payType, payAddress, bankNum, branch, tradePassword, qrCodeUrl, etWarn, dayLimit, "", "",name,"",
                new ResponseCallBack.SuccessListener<MessageResult>() {
                    @Override
                    public void onResponse(MessageResult response) {
                        hideLoading();
