...
public class BindPaypalPresenterImpl implements BindAccountContract.PaypalPresenter {
    ...
    @Override
    public void doBindPaypal(String payType, String account, String bank, String branch, String pwd, String etWarn, String dayLimit, String name, String expandField) {
        showLoading();
        payControllerModel.doBindBank(payType, account, bank, branch, pwd, "", etWarn, dayLimit, "", "", name, expandField,
    ...
    @Override
    public void doUpdatePaypal(Long id, String payType, String account, String bank, String branch, String pwd, String etWarn, String dayLimit, String name, String expandField) {
        showLoading();
        payControllerModel.doUpdateBank(id, payType, account, bank, branch, pwd, "", etWarn, dayLimit, "", "", name, expandField,
                new ResponseCallBack.SuccessListener<MessageResult>() {
                    @Override
                    public void onResponse(MessageResult response) {
                        hideLoading();
