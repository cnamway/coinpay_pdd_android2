...
import com.spark.coinpaypddd.adapter.PayWayAdapter;
    ...
    private void selectType(int type) {
        ...
        switch (type) {
            ...
            case 2://银行卡
                ...
                break;
            case 3://拼多多
                showActivity(BindPddActivity.class, null, ADD_PAY_WAY_REQ);
                break;
        }
    }
                ...
                if (payWaySetting.getStatus() != 2) {
                    ...
                    switch (payType) {
                        ...
                        case GlobalConstant.PDD_ALIPAY:
                            bundle = new Bundle();
                            bundle.putSerializable("data", payWaySetting);
                            showActivity(BindPddActivity.class, bundle, ADD_PAY_WAY_REQ);
                            break;
                    ...
                    case R.id.ivStatus:
                        ...
                        if (payWaySetting.getStatus() != 2) {
                            if (payWaySetting.getStatus() == 1) {
                                presenter.doUpdateStatusBank(payWaySetting.getId(), 0);
                            } else {
                                presenter.doUpdateStatusBank(payWaySetting.getId(), 1);
                            }
                        }
                        break;
                }
