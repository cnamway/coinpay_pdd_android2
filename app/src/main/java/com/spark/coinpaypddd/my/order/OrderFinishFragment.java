...
import com.spark.coinpaypddd.adapter.MyOrderFinishAdapter;
...
import com.spark.coinpaypddd.my.order.detail.MyOrderDetailFinishActivity;
...
public class OrderFinishFragment extends BaseFragment implements MyOrderContract.MyOrderFinishView {
    ...
    private void getList(boolean isShow) {
        ...
        map.put("status", "3,4,7,10");//订单完成3,胜诉赔付4,兑入订单超时放行7,平台强制放行10
