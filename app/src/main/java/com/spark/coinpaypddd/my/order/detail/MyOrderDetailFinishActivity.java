...
import static com.spark.coinpaypddd.my.order.OrderFinishFragment.orderAchive;
...
public class MyOrderDetailFinishActivity extends BaseActivity {
    ...
    private void initContent() {
        ...
        if (orderAchive.getMemberReward() == null) {
            llGetMoney.setVisibility(View.GONE);
        } else {
            llGetMoney.setVisibility(View.VISIBLE);
            tvGetPriceTag.setText(String.format(getString(R.string.str_pay_usdt_get), orderAchive.getCoinId()));
            tvGetPrice.setText(MathUtils.subZeroAndDot(orderAchive.getMemberReward() + ""));
        }
    }
