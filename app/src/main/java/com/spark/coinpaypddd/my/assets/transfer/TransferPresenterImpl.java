...
public class TransferPresenterImpl implements TransferContract.TransferPresenter {
    private TransferContract.TransferView transferView;
    private AssetControllerModel assetControllerModel;

    public TransferPresenterImpl(TransferContract.TransferView transferView) {
