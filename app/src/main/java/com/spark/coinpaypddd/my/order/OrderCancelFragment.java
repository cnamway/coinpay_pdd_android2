...
import com.spark.coinpaypddd.adapter.MyOrderCancelAdapter;
import com.spark.coinpaypddd.base.BaseFragment;
import com.spark.coinpaypddd.event.CheckLoginSuccessEvent;
import com.spark.coinpaypddd.event.OrderListFrushEvent;
import com.spark.coinpaypddd.my.order.detail.MyOrderDetailCancelActivity;
...
public class OrderCancelFragment extends BaseFragment implements MyOrderContract.MyOrderFinishView {
    ...
    private List<OrderAchiveVo> mDatas = new ArrayList<>();
    private MyOrderCancelAdapter adapter;
    public static OrderAchiveVo orderAchive;
    ...
    protected void setListener() {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                orderAchive = (OrderAchiveVo) adapter.getItem(position);
    ...
    private void getList(boolean isShow) {
        ...
        map.put("status", "0,6,8,11");//承兑商兑出单手动取消0,兑入订单超时取消6,兑入订单客户取消8,无法支付取消11
    ...
    @Override
    public void getOrderSuccess(List<OrderAchiveVo> list) {
