...
import com.spark.coinpaypddd.my.order.detail.MyOrderDetailContract;
import com.spark.coinpaypddd.my.order.detail.MyOrderDetailPresenterImpl;
import com.spark.coinpaypddd.pay.PayActivity;
import com.spark.coinpaypddd.view.AlertIosDialog;
import com.spark.coinpaypddd.view.ConfirmCancelDialog;
import com.spark.coinpaypddd.view.ReleaseDialog;
...
import static com.spark.coinpaypddd.overtime_order.OverTimeOrderListActivity.orderInTransit;
...
public class OverTimeOrderDetailActivity extends BaseActivity implements MyOrderDetailContract.MyOrderDetailIngView {
    ...
    @BindView(R.id.tvGetPriceTag)
    TextView tvGetPriceTag;
                ...
                for (int i = 0; i < payDatas.size(); i++) {
                    ...
                    switch (payType) {
                        ...
                        case GlobalConstant.PDD_ALIPAY:
                            bankNames[i] = MyApplication.getMyApplication().getResources().getString(R.string.str_pdd);
                            break;
    ...
    private void initContent() {
        ...
        if (payDatas != null && payDatas.size() > 0) {
            ...
            switch (payType) {
                ...
                case GlobalConstant.PAYPAL:
                    ...
                    break;
                case GlobalConstant.PDD_ALIPAY:
                    ivPayWay.setImageResource(R.mipmap.icon_pay_pdd);
                    type = 5;
                    break;
                case GlobalConstant.PDD_WECHAT:
                    ivPayWay.setImageResource(R.mipmap.icon_pay_pdd);
        ...
        tvGetPriceTag.setText(String.format(getString(R.string.str_pay_usdt_get), orderInTransit.getCoinId()));
    }
    ...
    protected void setOnClickListener(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.llPayType://选择支付方式
                if (orderInTransit.getDirection() == 2) {//兑出
                    if (payDatas != null && payDatas.size() > 0) {
                        showDialog();
                    } else {
