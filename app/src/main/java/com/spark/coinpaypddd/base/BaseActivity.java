...
import com.spark.coinpaypddd.event.EmptyEvent;
...
import static com.spark.coinpaypddd.utils.RestartUtils.START_LAUNCH_ACTION;
import static com.spark.coinpaypddd.utils.RestartUtils.STATUS_FORCE_KILLED;
...
public abstract class BaseActivity extends AppCompatActivity implements BaseContract.BaseView {
    ...
    public void dealError(HttpErrorEntity httpErrorEntity) {
        LogUtils.e("HttpErrorEntity===" + httpErrorEntity);
     ...
     * @param decimalNum
     */
    protected void setEditText(EditText editText, int decimalNum) {
