...
public class MyOrderIngAdapter extends BaseQuickAdapter<OrderInTransitVo, BaseViewHolder> {

    public MyOrderIngAdapter(@LayoutRes int layoutResId, @Nullable List<OrderInTransitVo> data) {
