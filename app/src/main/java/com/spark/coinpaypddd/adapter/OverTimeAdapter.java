...
public class OverTimeAdapter extends BaseQuickAdapter<OrderInTransitVo, BaseViewHolder> {

    public OverTimeAdapter(@LayoutRes int layoutResId, @Nullable List<OrderInTransitVo> data) {
