...
public class SharedPreferencesUtil {
    ...
    public static final String SP_KEY_AC_SID = "SP_KEY_AC_SID";
    public static final String SP_KEY_UC_SID = "SP_KEY_UC_SID";
    public static final String SP_KEY_SHOW = "SP_KEY_SHOW";
    public static final String SP_AHTH = "SP_AHTH";//承兑商是否认证
    public static final String SP_PAY_PASS = "SP_PAY_PASS";//资金密码是否设置
    ...
    public void setAcSid(Context context, String otcSid) {
        setParam(context, SP_KEY_AC_SID, otcSid);
    }

    public String getAcSid() {
        return getStringParam(SP_KEY_AC_SID);
    }

    public void setUcSid(Context context, String otcSid) {
        setParam(context, SP_KEY_UC_SID, otcSid);
    }

    public String getUcSid() {
        return getStringParam(SP_KEY_UC_SID);
    }
