...
public class PayControllerModel {
     ...
     * @param errorListener
     */
    public void doBindBank(String payType, String payAddress, String bank, String branch, String tradePassword, String qrCodeUrl, String etWarn, String dayLimit, String accountId, String accountNickname, String realName, String expandField,
        ...
        memberPayTypeDto.setExpandField(expandField);
     ...
     * @param errorListener
     */
    public void doUpdateBank(final Long id, String payType, String payAddress, String bank, String branch, String tradePassword, String qrCodeUrl, String etWarn, String dayLimit, String accountId, String accountNickname, String realName, String expandField,
                             final ResponseCallBack.SuccessListener<MessageResult> listener, final ResponseCallBack.ErrorListener errorListener) {
        final MemberPayTypeDto memberPayTypeDto = new MemberPayTypeDto();
        memberPayTypeDto.setPayType(payType);
        memberPayTypeDto.setPayAddress(payAddress);
